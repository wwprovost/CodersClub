...
class PuzzleView {
  ...
  constructor(puzzle, title, goalImage) {
    ...
    if (typeof this.puzzle.limit == "number") {
      this.root.textContent = "" + this.puzzle.limit + " max.";
    }

    let titleSpan = document.createElement("span");
    titleSpan.textContent = title;
    this.root.appendChild(titleSpan);

    let helpText = "go\n";
    if (this.puzzle.goUntilEnabled) {
      helpText += "go until [thing]\n";
    }
    if (this.puzzle.pushEnabled) {
      helpText += "push\n";
    }
    helpText += "turn\njump up\njump down\n";
    if (this.puzzle.repeatsEnabled) {
      helpText += "repeat [N] times\nrepeat until [thing]";
    }

    let helpDiv = document.createElement("div");
    helpDiv.id = "help";
    helpDiv.textContent = helpText;
    this.root.appendChild(helpDiv);
...
class ProgramUI {
  ...
  constructor(puzzle, view, clock, starters) {
    ...
    this.nextButton = document.getElementById(NEXT_ID);
    this.backButton = document.getElementById(BACK_ID);
    ...
    this.editorUIs = [];
    if (puzzle.players.length > 1 && !starters) {
      new TeamerUpper(getDefaultPageID(),
          "createTeam", "teamCreated", "teamToJoin", "joinTeam",
          "teamUp", "program2", this.setupTeam);
    } else {
      for (let index = 0; index < puzzle.players.length; ++index) {

        let editorUI = new EditorUI(puzzle, index, this.clock,
            starters ? starters[index] : null, this.runProgram, this.cancel);
        if (!starters) {
          editorUI.initToSave
              ([ this.runButton, this.nextButton, this.backButton ]);
        }

        this.editorUIs.push(editorUI);
      }
    }
  }
  ...
  setupTeam(team) {
    for (let index = 0; index < team.length; ++index) {
      let editorUI = new EditorUI(this.puzzle, index, this.clock,
          null, this.runProgram, this.cancel);
      if (team[index].me) {
        editorUI.initToSave
            ([ this.runButton, this.nextButton, this.backButton ]);
      } else {
        editorUI.initToLoad(team[index].teamCode, team[index].coder.id);
      }

      this.editorUIs.push(editorUI);

      let coderName = document.createElement("p");
      coderName.textContent = team[index].coder.name;
      document.getElementById(PROGRAM_ID + (index + 1))
          .insertBefore(coderName, editorUI.nthChild(1));
...
const pages = [ {
      name: "index.html",
      definition: "plat: 1 1 3 | goal: 4 1 | start: 1 1 1",
      goal: "HappyFace",
      examples: [ "# Click Run\ngo\ngo\ngo\n" ]
    }, {
      name: "Puzzle01.html",
      definition: "plat: 1 1 4, 1 2 4 | lad: 3 1 1 | goal: 5 2 | start: 1 1 1",
      goal: "HappyFace",
      examples: [ "go\ngo\njump up\ngo\ngo\n" ]
    }, {
      name: "Puzzle02.html",
      definition: "plat: 1 1 4, 1 2 4 | lad: 3 1 1 | goal: 1 2 | start: 1 1 1",
      goal: "HappyFace",
      examples: [ "go\ngo\njump up\nturn\ngo\ngo\n" ]
    }, {
      name: "Puzzle03.html",
      definition: "plat: 1 1 4, 1 2 2, 1 3 4 | chu: 5 3 1 | goal: 2 1 | start: 1 3 1",
      goal: "HappyFace",
      examples: [ "# Now you try:\n" ]
    }, {
      name: "Puzzle04.html",
      definition: "plat: 1 1 1, 4 1 1, 1 2 4 | " +
                  "lad: 2 1 1 | chu: 5 2 1 | goal: 4 1 | start: 1 1 1",
      goal: "HappyFace"
    }, {
      name: "Puzzle05.html",
      definition: "plat: 1 1 4, 1 2 2, 1 3 4 | chu: 5 3 1 | goal: 2 1 | start: 1 3 1",
      goal: "HappyFace",
      examples: [ "# Loops! Click Run\nrepeat 4 times\n  go\nturn\njump down\nrepeat 3 times\n  go\n" ],
      repeatsEnabled: true
    }, {
      name: "Puzzle05A.html",
      definition: "plat: 1 1 4, 1 2 2, 1 3 4 | chu: 5 3 1 | goal: 2 1 | start: 1 3 1",
      goal: "HappyFace",
      examples: [ "# This won't work.\n# Do you see why?\nrepeat 4 times\n  go\n  turn\njump down\nrepeat 3 times\n  go\n\n# Click Next ...\n" ]
    }, {
      name: "Puzzle06.html",
      definition: "plat: 1 1 4, 1 2 4 | lad: 5 1 1 | goal: 1 2 | start: 1 1 1 | limit: 6",
      goal: "HappyFace"
    }, {
      name: "Puzzle07.html",
      definition: "plat: 1 1 0, 4 1 1, 1 2 3, 1 3 4 | " +
                  "lad: 1 1 2, 4 1 1 | chu: 5 3 1 | goal: 2 2 | start: 1 1 1",
      goal: "HappyFace"
    }, {
      name: "Puzzle08.html",
      definition: "plat: 1 1 1, 1 2 1, 1 3 1, 1 4 1 | " +
                  "chu: 2 2 1, 1 3 1, 2 4 1 | goal: 1 1 | start: 1 4 1 | limit: 5",
      goal: "Clover"
    }, {
      name: "Puzzle09.html",
      definition: "plat: 1 5 1, 4 5 1, 1 4 4, 1 3 1, 4 3 1, 1 2 4, 1 1 0 | " +
                  "lad: 4 4 1, 2 2 1 | chu: 2 5 1, 5 5 2, 1 3 2, 4 3 1 |" +
                  "goal: 1 1 | start: 1 5 1 | limit: 10",
      goal: "Clover"
    }, {
      name: "Puzzle10.html",
      definition: "plat: 1 1 0, 4 2 1, 1 3 4, 1 4 4 | " +
                  "lad: 5 2 2 | chu: 4 3 1, 1 4 2 |" +
                  "goal: 1 1 | start: 2 3 1",
      goal: "HappyFace",
      examples: [ "repeat until chute\n  go\njump down\nrepeat until ladder\n  go\njump up\nturn\nrepeat until chute\n  go\njump down\n\n#You can repeat until\n#chute, ladder, goal,\n#edge or anything\n" ]
    }, {
      name: "Puzzle11.html",
      definition: "plat: 1 3 1, 1 1 1, 2 4 4, 4 2 2, 4 3 2 | " +
                  "lad: 2 1 3, 4 2 1 | chu: 1 3 1, 6 4 2 |" +
                  "goal: 5 3 | start: 2 3 0 | limit: 12",
      goal: "Clover"
    }, {
      name: "Puzzle12.html",
      definition: "plat: 1 1 5, 1 2 5, 1 3 5, 1 4 5, 1 5 5 | " +
                  "lad: 1 1 1, 3 2 3, 6 2 1, 1 3 1 |" +
                  "goal: 6 4 | start: 6 1 0 | limit: 9",
      goal: "HappyFace"
    }, {
      name: "Puzzle13.html",
      definition: "plat: 3 1 3, 2 2 4, 2 3 4, 1 4 5 | " +
                  "lad: 3 2 2 | chu: 4 4 1, 2 3 1, 5 2 1, 3 1 1 |" +
                  "goal: 4 1 | start: 1 4 1 | limit: 7",
      goal: "HappyFace"
    }, {
      name: "Puzzle14.html",
      definition: "plat: 1 1 4, 1 2 4, 1 3 4, 1 4 4, 1 5 4 | " +
                  "lad: 1 1 2, 2 3 1, 3 3 1, 4 3 1, 5 3 2 | chu: 3 2 1 |" +
                  "goal: 2 5 | start: 5 2 0",
      goal: "HappyFace",
      examples: [ "# Instead of\n# repeat until chute\n#   go\ngo until chute\njump down\ngo until ladder\njump up\nturn\ngo until edge\njump up\nturn\ngo until goal\n" ],
      goUntilEnabled: true
    }, {
      name: "Puzzle15.html",
      definition: "plat: 1 1 0, 1 2 2, 3 3 2, 4 4 2 | " +
                  "lad: 1 1 1, 3 2 1, 4 3 1 | goal: 6 4 | start: 1 1 1",
      goal: "HappyFace",
      ...
      definition: "plat: 1 1 0, 1 2 2, 3 3 2, 4 4 2 | " +
                  "lad: 1 1 1, 3 2 1, 4 3 1 | goal: 6 4 | start: 1 1 1",
      goal: "HappyFace",
      examples: [ "repeat until goal\n  jump up\n  go until anything\n" ]
    }, {
      name: "Puzzle17.html",
      definition: "plat: 1 1 0, 1 2 0, 1 3 0, 3 1 2, 3 2 2, 3 3 2, 1 4 4 | " +
                  "lad: 1 1 1, 1 2 1, 1 3 1 | " +
                  "chu: 5 4 1, 3 3 1, 4 2 2, 5 2 1 | " +
                  "goal: 3 1 | " +
                  "start: 1 1 1 | limit: 10",
      goal: "HappyFace"
    }, {
      name: "Puzzle18.html",
      definition: "plat: 1 1 0, 1 2 0, 1 3 0, 1 4 1, 3 1 2, 4 4 1 | " +
                  "lad: 1 1 1, 1 2 1, 1 3 1, 5 1 3 | " +
                  "goal: 5 4 | " +
                  "start: 1 1 1 | limit: 8",
      goal: "HappyFace"
    }, {
      name: "Puzzle19.html",
      definition: "plat: 1 1 5, 1 2 5, 1 3 5 | " +
                  "lad: 2 1 1, 3 1 1, 4 1 1, 5 1 2, 6 1 1 | " +
                  "goal: 1 3 | " +
                  "start: 1 1 1 | limit: 5",
      goal: "HappyFace"
    }, {
      ...
      name: "Puzzle21.html",
      definition: "plat: 1 1 0, 1 4 1, 2 2 2, 4 3 2, 4 4 1, 6 1 0 | " +
                  "lad: 1 1 3, 4 2 2 | chu: 2 4 1, 5 4 1, 6 3 1 | " +
                  "goal: 6 1 | start: 1 1 1 | limit: 7",
      goal: "Heart"
    }, {
      name: "Puzzle22.html",
      definition: "plat: 1 5 4, 2 4 3, 2 3 3, 1 2 3, 2 1 3 | " +
                  "lad: 4 2 2, 5 1 2 | chu: 1 5 1, 2 4 3 | " +
                  "goal: 3 3 | start: 4 5 0 | limit: 8",
      goal: "HappyFace"
    }, {
      name: "Puzzle23.html",
      definition: "plat: 1 5 4, 2 4 3, 2 3 2, 1 2 5, 2 1 3 | " +
                  "lad: 5 2 2 | chu: 1 5 1, 2 4 3, 3 4 1, 4 4 1 | " +
                  "goal: 3 1 | start: 4 5 0 | limit: 8",
      goal: "HappyFace"
    }, {
      name: "Puzzle24.html",
      definition: "plat: 2 1 2, 2 2 6, 3 3 5, 1 4 7, 1 5 6, 1 6 5 | " +
                  "lad: 4 2 2, 6 2 4, 8 2 1, 3 4 1, 4 4 1, 5 4 2, 7 4 1 | " +
                  "chu: 2 6 3, 3 6 1, 4 6 1, 1 5 1, 3 3 2, 5 3 2, 7 3 2 | " +
                  "goal: 2 1 | start: 1 5 1 | limit: 15",
      goal: "Heart"
    }, {
      name: "Puzzle25.html",
      definition: "plat: 1 1 3, 6 1 3, 1 2 1, 8 2 1, 1 3 1, 6 3 0, 8 3 1, 1 4 2, 5 4 4 | " +
                  "lad: 3 1 3, 9 1 1, 8 2 1, 9 3 1 | chu: 1 4 1, 2 3 1 | " +
                  "goal: 1 2 | start: 6 3 | limit: 15",
      goal: "Heart"
    }, {
      name: "Puzzle26.html",
      definition: "plat: 1 1 1, 4 1 1, 2 2 1, 5 2 1, 3 3 1, 6 3 1, 4 4 0, 7 4 0, " +
                        "3 5 1, 6 5 1, 2 6 1, 5 6 1, 1 7 1, 4 7 1, 1 8 0, 4 8 0 | " +
                  "lad: 1 1 7, 4 1 3, 4 5 3 | " +
                  "goal: 7 5 | start: 7 4 0 | limit: 16",
      goal: "Heart"
    }, {
      name: "Puzzle27.html",
      definition: "plat: 1 1 5, 2 2 3, 1 3 2, 5 3 1 | " +
                  "lad: 3 1 2 | " +
                  "goal: 5 3 | start: 2 2 1",
      goal: "HappyFace",
      examples: [ "# Now you can push\n# things around!\n\ngo\npush\npush\ngo\nturn\ngo until ladder\njump up\n" ],
      pushEnabled: true
    }, {
      name: "Puzzle28.html",
      definition: "plat: 2 1 0, 1 3 4, 1 4 4 | " +
                  "lad: 4 3 1 | chu: 3 4 2 | " +
                  "goal: 2 1 | start: 5 3 0",
      goal: "HappyFace"
    }, {
      name: "Puzzle29.html",
      definition: "plat: 3 1 2, 1 2 4, 1 3 2, 1 4 6, 5 5 2 | " +
                  "lad: 1 2 1, 7 4 1 | chu: 2 3 2, 6 5 2 | " +
                  "goal: 5 1 | start: 7 4 0 | limit: 15",
      goal: "Clover",
    }, {
      name: "Puzzle30.html",
      definition: "plat: 1 1 5, 1 2 5, 1 3 0, 6 3 0 | " +
                  "lad: 1 1 2 | chu: 3 2 1 | " +
                  "goal: 6 3 | start: 1 1 1 | limit: 15",
      goal: "Heart",
    }, {
      name: "Puzzle31.html",
      definition: "plat: 1 1 2, 5 1 1, 8 1 1, 1 2 8, 3 3 2, 6 4 2, 1 5 8 | " +
                  "lad: 3 1 2, 6 1 3, 9 1 4 | chu: 2 2 1, 4 3 2, 7 4 3 | " +
                  "goal: 1 5 | start: 2 2 1 | limit: 15",
      goal: "Clover",
    }, {
      name: "Puzzle32.html",
      definition: "plat: 1 1 6, 1 2 5, 1 3 2, 6 3 0, 1 4 4, 1 5 1, 5 5 0, 1 6 3, 1 7 0, 4 7 0 | " +
                  "lad: 4 1 2, 3 3 2, 2 5 2 | chu:  |" +
                  "goal: 1 7 | start: 4 7 0 | limit: 12",
      goal: "Heart",
    }, {
      name: "TeamPuzzle01.html",
      definition: "plat: 1 1 2, 1 2 2, 3 3 2 | " +
                  "lad: 2 1 2 |" +
                  "goal: 5 3 | start: 2 2 1, 1 1 1",
      examples: [
          "# Click Run -- oops!\n# Then erase all of\n# this, and type\n# 'push'.\n# Run again -- better!\n",
          "go until ladder\njump up\ngo until goal\n"
        ],
      ...
      name: "TeamPuzzle02.html",
      definition: "plat: 4 1 1, 1 2 4, 1 3 4, 1 4 2 | " +
                  "lad: 4 2 2, 5 1 2 |" +
                  "goal: 1 4 | start: 1 2 1, 4 1 1",
      goal: "Clover",
    }, {
      name: "TeamPuzzle03.html",
      definition: "plat: 3 1 3, 1 2 0, 4 2 2, 1 3 5, 1 4 3 | " +
                  "lad: 5 2 2, 6 1 1 | chu: 2 4 2, 3 4 1 | " +
                  "goal: 1 2 | start: 3 1 1, 4 4 0",
      goal: "Heart",
    }, {
      name: "TeamPuzzle04.html",
      definition: "plat: 3 1 1, 3 4 3, 4 5 1, 1 6 2 | " +
                  "lad: 4 1 5 | chu: 5 5 2 | " +
                  "goal: 1 6 | start: 4 5 1, 5 5 0",
      goal: "Clover",
    }, {
      name: "TeamPuzzle05.html",
      definition: "plat: 1 1 2, 4 2 0, 4 3 2, 4 4 2, 2 5 4, 3 6 2 | " +
                  "lad: 2 1 5 | chu: 5 6 2, 5 4 2, 6 4 1 | " +
                  "goal: 4 2 | start: 2 5 1, 6 5 0",
      goal: "Heart",
    }
  ];
...
export class Page {
  constructor() {
    window.onload = function() {
        ...
        // Fill in false values until an explicit true is found,
        // and true values from then on:
        let filler = {
            repeatsEnabled: false,
            goUntilEnabled: false,
            pushEnabled: false
          };
        for (let page of pages) {
          for (let prop in filler) {
            if (prop in page) {
              filler[prop] = true;
            } else {
              page[prop] = filler[prop];
            }
          }
        }
        ...
        if (canGoBack) {
          backButton.onclick = ev => {
              window.location.href = pages[position - 1].name;
            };
        }
        ...
        let title = page.name.replace("index", "")
                             .replace("Puzzle0", "Puzzle")
        ...
        let view = new PuzzleView(puzzle, title, page.goal);
